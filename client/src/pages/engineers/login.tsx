...
import { z } from "zod";
import { HardHat, Loader2, Mail, KeyRound } from "lucide-react";
...
export default function EngineerLoginPage() {
  const { requestOtp, verifyOtp } = useEngineerAuth();
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">Engineer Hub</h1>
            <p className="text-muted-foreground">One place to plan, communicate, and track your jobs</p>
          </div>
          ...
          <Card className="shadow-lg">
            <CardHeader className="text-center pb-4">
              ...
              <CardDescription>
                {step === "email"
                  ? "Enter your engineer account email to receive a login code"
